...
def open_page_using_url(data):
    ...
    for block in data:
        ...
        # fill out form with "Court Establishment" option
...
def loop_over_case_type_options(data_array):
    ...
    with open("scannedData.json", mode="w") as jsonFile:
...
urls = file_interactor.get_case_type_urls_from_csv()[2:4]
r = open_page_using_url(urls)
file_interactor.write_dict_into_json_file("result.json", r)
print(r)
